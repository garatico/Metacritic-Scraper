...
request_headers = {'User-Agent' : 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:96.0) Gecko/20100101 Firefox/96.0'}
# List attributes per game
title_arr, score_arr, rank_arr, url_arr, platform_arr, release_date_arr = [], [], [], [], [], []
platform_dict = {'title' : title_arr,'score' : score_arr,'rank': rank_arr,'url' : url_arr,'platform' : platform_arr,'release_date' : release_date_arr}
...
''' SCRAPING METHODS '''
#main_combined_multiple(9, 20, request_headers, [platform_list[8]])
#individual_combined_timed(0, 200, request_headers, url_arr)
...
local_platform_append(local_soup_arr, platform_dict)
...
# SQL
platform_sql_conn = sqlite3.connect(pwd + '/db/game_db.db')
platform_npT.to_sql("game_db", platform_sql_conn)
platform_sql_conn.close()
